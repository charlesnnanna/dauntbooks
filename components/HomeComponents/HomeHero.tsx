...
export default function HomeHero() {
  return (
    <div className="flex md:flex-row flex-col border-0 my-20 md:px-[180px] px-[20px]">
      {/* Hero description */}
      <div className="border-0 md:self-center py-2 my-2">
        ...
        <h1 className="text-6xl font-bold py-4 md:w-[600px] min-w-[20vw]">
        ...
        <div className="my-6">
          <ul className="border-0 flex flex-row justify-start flex-wrap md:gap-20 gap-10 font-bold text-xs md:text-md list-none">
